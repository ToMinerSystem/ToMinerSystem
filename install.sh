...
readonly EXPECTED_SHA256="4042dfac31adbf2517fa5c4d615c727433090d8dcf4190083d6920c9470c9789"
...
case "${command_name}" in
  ...
  *)
    echo "用法：sudo bash install-server.sh {install|start|stop|restart|status|web-port|reset-password|uninstall}" >&2
    exit 2
    ;;
esac
